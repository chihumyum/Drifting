-- Extend immutable Agent entity receipts to storyline membership and Agent
-- memory transactions. SQLite CHECK constraints require a table rebuild.
...
CREATE TABLE `agent_runtime_entity_write_receipt_next` (
	...
	CHECK (`entity_kind` IN (
		...
		'storyline_membership', 'memory', 'project'
	)),
...
INSERT INTO `agent_runtime_entity_write_receipt_next` (
	`id`, `effect_id`, `command_id`, `direction`, `project_id`, `session_id`,
	`tool_name`, `entity_kind`, `entity_id`, `expected_revision`, `result_revision`,
	`preimage_json`, `preimage_hash`, `postimage_json`, `postimage_hash`, `created_at`
)
SELECT
	`id`, `effect_id`, `command_id`, `direction`, `project_id`, `session_id`,
	`tool_name`, `entity_kind`, `entity_id`, `expected_revision`, `result_revision`,
