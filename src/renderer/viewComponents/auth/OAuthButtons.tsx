...
import { OAUTH_PROVIDER_CONFIG, OAUTH_PROVIDERS, SupportedOAuthProvider } from "@/renderer/lib/oauth-providers";
...
export const OAuthButtons = () => {
    ...
    useEffect(() => {
        const cleanup = window.electronAPI.auth.onOAuthCallback(async ({ token, error: callbackError }) => {
            setLoading(null);
