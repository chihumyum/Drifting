...
const GROUPS = {
  providers: [
    ...
    'src/renderer/lib/ai/client/providers/deepseek.test.ts',
...
const LINT_FILES = [
  ...
  'src/renderer/lib/ai/client/build-default-client.ts',
  'src/renderer/lib/ai/client/providers/deepseek.ts',
  'src/renderer/lib/ai/client/providers/openai.ts',
  'src/renderer/lib/ai/types.ts',
