...
| Voice-authored capture        | TODO: let mobile authors speak an idea, find its context, and place it safely in the right part of the project | [`../voice-authored-capture.md`](../voice-authored-capture.md) |
