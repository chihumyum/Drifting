...
| G   | Agent checkpoint/rewind/fork product removed                                  | [`../entity-snapshot-history.md`](../entity-snapshot-history.md); migration `0080_retire_shadow_arc_evolve.sql` and retirement acceptance remain the evidence |
